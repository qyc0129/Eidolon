...
public class StaffView extends View {
    ...
    public StaffView(Context context, AttributeSet attributes) {
        ...
        staffPaint.setColor(Color.alpha(0));

        backgroundColor = new Paint();
        backgroundColor.setColor(Color.alpha(0));
    ...
    protected void onDraw(Canvas canvas) {
        ...
        while (it.hasPrevious() && posX > -noteDistance) {
            ...
            final String noteName = noteNames[model.isFlat() ? 0 : 1][n.note];
